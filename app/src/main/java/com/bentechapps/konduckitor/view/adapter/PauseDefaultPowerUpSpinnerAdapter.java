 ...
 */
public class PauseDefaultPowerUpSpinnerAdapter extends ArrayAdapter<ShopItem> {
    public PauseDefaultPowerUpSpinnerAdapter(Context context, int resource, int textView, ShopItem[] objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if(view == null) {
            view = View.inflate(getContext(), R.layout.pause_power_up_item, null);
        }
