 ...
 */
public abstract class FemalePerson implements Person {
    ...
    public FemalePerson(Context context) {
    ...
    public static List<FemalePerson> getFemalePersonList(final Context context) {
        FemalePerson person;
        List<FemalePerson> set = new ArrayList<>();
    ...
    public boolean equals(Object o) {
        if(o == null)
            return false;
        if(!(o instanceof FemalePerson))
            return false;
        return (((FemalePerson) o).drawableId == this.drawableId);
    }
